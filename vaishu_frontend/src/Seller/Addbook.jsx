...
const handleSubmit = async (e) => {
  ...
  return (
    <div> 
        <Vnavbar/>
    <div className="max-w-md mx-auto mt-8 p-4 border rounded shadow-lg" style={{backgroundColor:"lightskypurple"}}>
      ...
      <div className="mb-4">
        ...
        <button
          type="submit"
          className="bg-purple-900 hover:bg-purple-500 text-white font-semibold py-2 px-4 rounded focus:outline-none focus:shadow-outline"
        >
          Submit
        </button>
      </form>
