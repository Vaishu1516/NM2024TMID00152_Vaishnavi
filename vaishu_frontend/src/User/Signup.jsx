...
const Signup = () => {
  ...
  return (
    <div className="flex items-center justify-center min-h-screen bg-gray-100">
      ...
      {/* <div className=" h-5  w-full  bg-red-500 transform skew-y-6 origin  "></div> */}
        ...
        <form className="space-y-6" onSubmit={handleSubmit}>
          ...
          <p className="text-sm text-gray-600">
            ...
            <button
              onClick={formHandle1}
              className="text-red-500 hover:underline focus:outline-none focus:ring focus:border-red-300 transition-all duration-300"
            >
              Login
            </button>
          </p>
