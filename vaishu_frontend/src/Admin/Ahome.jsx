...
//           <div className="w-64 h-32 bg-light-dark-500 rounded-lg shadow-md flex flex-col justify-center items-center text-xl font-bold text-gray-800">
...
function Ahome() {
  ...
  const data = [
    ...
    { name: 'Items', value: totalItems, fill: 'light-dark' }, 
    ...
    <div>
      ...
      <Card body style={{ background: "white", width: "80%", marginLeft: "10%", marginTop: "20px", height: "580px" }}>
        ...
        <Link to="/vendors" style={{textDecoration:"none"}}>
         <div className="w-64 h-32 bg-light-dark-500 rounded-lg shadow-md flex flex-col justify-center items-center text-xl font-bold text-gray-800 text-center">
